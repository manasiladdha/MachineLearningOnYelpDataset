...
<body>
	<div class="login">
		<h1>Login</h1>
			<spring:form id="LoginUser" action="login.htm" method="post" modelAttribute="loggedInUser">
				<div class="form-group">
					<label for="username"><span	class="glyphicon glyphicon-user"></span> UserName</label>
					<spring:input type="text" id="username" class="form-control" path="username" placeholder="Enter username"
						required="required" />
				</div>
				<div class="form-group">
					<label for="password"><span	class="glyphicon glyphicon-eye-open"></span> Password</label>
					<spring:input type="password" class="form-control"	path="password" id="password" placeholder="Enter password" required="required" />
				</div>
				<div>
					<label id="loginError" class="loginError"></label>
				</div>
				<input type="submit" id="loginBtn" class="btn btn-danger btn-block"	value="Login" />
			</spring:form>
	</div>
